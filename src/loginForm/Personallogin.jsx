    ...
    <div>
         <div>
            <div className='flex justify-between '>
                <div className='w-[450px] flex flex-col px-8 mr-32 justify-center bg-[#111049] text-white rounded-2xl  h-[600px] items-center gap-y-8'>
                    <div className='text-center'>
                        <h2 className='font-bold text-xl'> Account Login <span className='font-bold text-3xl text-firstColor' >Team</span> <span className='font-bold text-3xl text-firstColor' >Radiant</span> </h2>
                    </div>
